...
apple_news_polarity$Article <- tolower(apple_news_polarity$Article) # convert all text to lowercase 
apple_news_polarity$Article <- removePunctuation(apple_news_polarity$Article) # removes the punctuation within all text 
apple_news_polarity$Article <- removeSymbols(apple_news_polarity$Article) # removes symbols such as '?', '%' and more
apple_news_polarity$Article <- removeNumbers(apple_news_polarity$Article) # removes number from all text 
apple_news_polarity$Article <- removeWords(apple_news_polarity$Article, words = c(stopwords(kind = "en"), "marketwatch", "mw", "zachs", "zacks")) # removes filler words 
apple_news_polarity$Article <- stripWhitespace(apple_news_polarity$Article) # removes the whitespace within all text 
